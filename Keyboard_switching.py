...
def switch_case(case_id):
    ...
    case_params = get_case_parameters(case_id)

    print("\nSwitched to:", case_params["case_id"])
    print("Severity:", case_params["severity"])
    print("Texture:", case_params["texture"])
    print("HDR:", case_params["hdr"])
    print("Progression score:", round(case_params["progression_score"], 3))
...
# ============================================================
# KEYBOARD CASE SWITCHING
# ============================================================

plotter.add_key_event("1", lambda: switch_case("Case A"))
plotter.add_key_event("2", lambda: switch_case("Case B"))
plotter.add_key_event("3", lambda: switch_case("Case C"))
plotter.add_key_event("4", lambda: switch_case("Case D"))
plotter.add_key_event("5", lambda: switch_case("Case E"))
plotter.add_key_event("6", lambda: switch_case("Case F"))
plotter.add_key_event("7", lambda: switch_case("Case G"))
plotter.add_key_event("8", lambda: switch_case("Case H"))
